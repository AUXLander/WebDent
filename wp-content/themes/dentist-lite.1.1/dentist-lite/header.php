...
<?php esc_html_e( 'Skip to content', 'dentist-lite' ); ?>
</a>
<?php
...
<div class="siteheader <?php echo esc_attr($inner_cls); ?>">       
<div class="container">    
     <div class="logo">
...
<?php }else{ ?>
<img src="<?php echo esc_url( get_template_directory_uri() ) ; ?>/images/slides/defaultslide.jpg" title="#slidecaption<?php esc_attr( $i ); ?>" alt="<?php echo esc_attr($alt); ?>" />
<?php } ?>
<?php $i++; endwhile; ?>
</div>   
